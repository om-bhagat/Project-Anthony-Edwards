...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const athleteImages = [
    ...
    { src: 'assets/images/49-points.png', text: "At age 21, Anthony Edwards scored a career-high 49 points in a game, blending explosive drives, precise shooting, and relentless energy, further cementing his status as one of the NBA’s brightest young stars.", size: 'athletesmall5'},
